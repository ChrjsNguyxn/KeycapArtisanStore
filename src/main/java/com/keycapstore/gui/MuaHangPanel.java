...
public class MuaHangPanel extends JPanel {
    ...
    private void initData() {
        ...
        productList.add(
                new KeycapProduct("KC001", "GMK Olivia++ Dark", "GMK", 2890000, 3500000, "Cherry", "ABS", 15000, 4.9f));
        productList.add(
                new KeycapProduct("KC002", "PBT Hanami Dango", "Tai-Hao", 650000, 890000, "OEM", "PBT", 8500, 4.8f));
        productList.add(
                new KeycapProduct("KC003", "ePBT Kuro Shiro", "ePBT", 990000, 1290000, "Cherry", "PBT", 6200, 4.7f));
        ...
        productList.add(
                new KeycapProduct("KC006", "JTK Night Sakura", "JTK", 1690000, 2100000, "Cherry", "ABS", 2800, 4.9f));
        ...
        productList
                .add(new KeycapProduct("KC009", "Keychron OEM", "Keychron", 450000, 590000, "OEM", "PBT", 18200, 4.6f));
